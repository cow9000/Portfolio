...
<html lang="en">
<head>
<title>Build ME Blocks - Settings</title>
    ...
    <section id="content">
        <div class="container">
        	<div class="block type3">
            	<div class="inner">
                	<h3 class="t_left p3">Member Settings</h3>
                    <div class="wrapper p1">
                        <article class="col-3">
						<?php echo $error; ?>
						
						<div id="register" style='width:900px;'>
						<div id="inline" style="display:inline; float:left;">
						<h3 class="t_left p3">Change password</h3>
						<form action="settings.php" method="post">
						
							<input type="password" name="password" placeholder="Current Password"></input>
							<input type="password" name="2password" placeholder="new password" style='display:block;'></input>
							<input type="password" name="repassword" placeholder="Retype new password"></input>
							<br>
							<input type="submit" style="cursor:pointer;" value="Change Password"></a>
						</form>
						</div>
