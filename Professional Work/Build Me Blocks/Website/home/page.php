...
<html lang="en">
<head>
<title>Build ME Blocks - Index</title>
...
<body id="page1">
<div class='topnav'>
                <h1><a href='../about'>BuildMeBlocks</a></h1>
                <div class='float'>
                	 <?php echo $welcomeUser; ?>
			 <p class='dailyMessage'><?php echo $dailyMessage; ?></p>
		</div>
</div>
<!--==============================header=================================-->
...
<!--==============================content================================-->
   <section id="content">
    		<br>
    		<div style="width:100%;"><p class="c">Play . Work . Love</p></div>
	<div id="image"><img src='../images/board.JPG' style=' width:700px; height:350px; margin:15px; margin-bottom:50px;'></img></div>
	<form action="../login/" method="POST">
	<div id="center3">
		<a href="../about" style="display:inline-block;"><div class="buttons">Behind the Scenes</div></a>
		<a href="../programs" style="display:inline-block;"><div class="buttons2">Special Agent Mission</div></a>
		<a href="../reading" style="display:inline-block;"><div class="buttons3">Reading Adventures</div></a>
