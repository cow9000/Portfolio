        	...
        	<div class="block type3">
            	<div class="inner">
                    ...
                    <div class="wrapper p1">
                        <article class="col-3">
                        	<form action="fps.php?id=<?php echo $_GET["id"]?>" method="post">
								New password:    <input type='password' name="password" placeholder="Email"></input>
								<Br>
								retype password: <input type='password' name="repassword" placeholder="Email"></input>
