                ...
                <div class="grid_8" style="width:95%;">
                	<div class="block type1">
                    	<div class="inner type2">
							...
							<p class='large_text p1'>be a part of something meaningful! Build ME Blocks is excited for each person that brings the programsinto their home.  We know kids love games, need to learn how to interact in the real world and are motivated by earnings and prizes.  Purchase the Build ME Blocks program materials and be on your way to an exciting, fun, learning experience! </p>
							<a href="register.php" class="large_text">Register now!</div>
							</div>
                        </div>
                    </div>
                </div>
