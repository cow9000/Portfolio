    ...
    <section id="content">
        <div class="container">
        	<div class="block type3">
            	<div class="inner">
                	<h3 class="t_left p3">Registration forum</h3>
                    <div class="wrapper p1">
                        <article class="col-3">
                        	...
                        	<form action="register.php" method="post">
								...
								By registering, you are agreeing to the <a href="tos.php">Terms of Service</a> and the <a href="privacy.php">Privacy Policy</a>.
								<br>
